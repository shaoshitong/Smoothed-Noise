...
if __name__ == "__main__":
    ...
    root_path = os.path.join("/data/shaoshitong/Chronomagic/", f"{args.method}", "total_1509", args.tag + f"_en_{args.ensemble}_fast_{args.fast_ensemble}_mom_{args.momentum}_enr_{args.ensemble_rate}_recall_{args.recall_timesteps}")

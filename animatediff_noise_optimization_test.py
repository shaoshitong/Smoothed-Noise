...
local_path = "./result_fe.gif"
output = pipe(
    prompt="In slow motion, a dessert fork gently presses into the center of the cake. As the fork goes deeper, the outer crust begins to crack.",    # negative_prompt="",
